...
{
  Node * test_data = new Folder ("./1");
  Node * folder = new Folder("./1/2");
  Node * folder2 = new Folder("./1/2/3");
  Node * a_out = new File("./1/2/4");
  Node * a_out2 = new File("./1/2/3/4");
  folder2->add(a_out2);
  folder->add(a_out);
  folder->add(folder2);
  //folder->add(a_out);
  test_data->add(folder);
  //ASSERT_EQ("./a.out",folder2->find("a.out"));
  //ASSERT_EQ("./folder/folder2/a.out",test_data->find("a.out"));
  ASSERT_EQ("./folder/a.out\n./folder/folder2/a.out",test_data->find("4"));
}*/
